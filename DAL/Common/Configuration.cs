...
namespace DAL.Common
{
    ...
    {
        public static string key = "Tecxpert@MP#123$456%789^";
        public static string APPName = "com.tecxpert.saras_pro";
        public static string APPVersion = "46";//"0";
        public static string APPUserCode = "jr1204";
        public static string PWD = "1204";
